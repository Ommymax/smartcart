              ...
              children: [
                ...
                _Section(
                  ...
                  rows: {
                    ...
                    'Front distance': telemetry.frontSensor.distanceCm == null ? 'Waiting for first reading' : '${telemetry.frontSensor.distanceCm} cm',
                    'Left check': telemetry.leftSensor.active ? 'OK' : 'Not available',
                    'Left distance': telemetry.leftSensor.distanceCm == null ? 'Waiting for first reading' : '${telemetry.leftSensor.distanceCm} cm',
                    'Right check': telemetry.rightSensor.active ? 'OK' : 'Not available',
                    'Right distance': telemetry.rightSensor.distanceCm == null ? 'Waiting for first reading' : '${telemetry.rightSensor.distanceCm} cm',
                  },
                ),
                ],
              ],
